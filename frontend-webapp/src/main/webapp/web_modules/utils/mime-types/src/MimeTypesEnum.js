...
export default [
  ...
  { extension: '.css', label: 'Cascading Style Sheets (CSS)', mime: 'text/css' },
  ...
  { extension: '.gif', label: 'Graphics Interchange Format (GIF) (image animée)', mime: 'image/gif' },
  { extension: '.htm', label: 'HyperText Markup Language (HTML)', mime: 'text/html' },
  { extension: '.html', label: 'HyperText Markup Language (HTML)', mime: 'text/html' },
  ...
  { extension: '.jpeg', label: 'JPEG Image', mime: 'image/jpeg' },
  { extension: '.jpg', label: 'JPEG Image', mime: 'image/jpeg' },
  { extension: '.js', label: 'JavaScript (ECMAScript)', mime: 'application/js' },
  { extension: '.json', label: 'JSON Format', mime: 'application/json' },
  ...
  { extension: '.pdf', label: 'Adobe Portable Document Format', mime: 'application/pdf' },
  ...
  { extension: '.svg', label: 'Scalable Vector Graphics (SVG)', mime: 'image/svg+xml' },
  ...
  { extension: '.tif', label: 'Tagged Image File Format (TIFF)', mime: 'image/tiff' },
  { extension: '.tiff', label: 'Tagged Image File Format (TIFF)', mime: 'image/tiff' },
  ...
  { extension: '.xhtml', label: 'XHTML', mime: 'application/xhtml+xml' },
  { extension: '.xls', label: 'Microsoft Excel', mime: 'application/vnd.ms-excel' },
  { extension: '.xml', label: 'XML', mime: 'application/xml' },
