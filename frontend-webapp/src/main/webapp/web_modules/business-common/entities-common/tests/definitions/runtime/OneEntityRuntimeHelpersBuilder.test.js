...
/**
* Test OneEntityRuntimeHelpersBuilder
* @author Raphaël Mechali
*/
describe('[Entities Common] Testing OneEntityRuntimeHelpersBuilder', () => {
  it('should be defined', () => {
    assert.isDefined(OneEntityRuntimeHelpersBuilder)
  })
  it('should provide the main API functions: getFetchAction and getReducePromise', () => {
    const helperBuilder = new OneEntityRuntimeHelpersBuilder(buildOneElementTarget('a'))
