...
const messages = {
  ...
  'order.list.options.error.ORDER_MUST_NOT_BE_RUNNING': 'That order is now running, it cannot be deleted',
  'order.list.options.error.ORDER_MUST_BE_PENDING_OR_RUNNING': 'That order must be pending or running before being paused',
