...
const messages = Object.assign({
  'fragment.list.title': 'Liste des ensembles d\'attributs de modèles de données',
  'fragment.list.subtitle': 'Un ensemble d\'attribut (fragment) permet de regrouper plusieurs attributs dans un ensemble cohérent',
