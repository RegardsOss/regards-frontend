...
const messages = Object.assign({
  ...
  'form.configuration.result.document.titles.message': 'Titre de la vue documents',
  'form.configuration.result.document.section.label.en': 'Anglais',
  'form.configuration.result.document.section.label.fr': 'Français',
