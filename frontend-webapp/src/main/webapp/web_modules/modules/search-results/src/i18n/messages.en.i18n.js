...
const messages = Object.assign({
  ...
  'form.configuration.result.document.titles.message': 'Document view title',
  'form.configuration.result.document.section.label.en': 'English',
  'form.configuration.result.document.section.label.fr': 'French',
