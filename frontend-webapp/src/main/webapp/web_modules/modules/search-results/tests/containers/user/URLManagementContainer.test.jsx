...
describe('[Search Results] Testing URLManagementContainer', () => {
  ...
  it('Should initialize redux state from URL', () => {
    ...
    assert.equal(spiedInit.viewObjectType, DamDomain.ENTITY_TYPES_ENUM.DATASET, 'View object type must be retrieved from URL')
  ...
  it('Should block target type dataset from URL when modules is not displaying datasets', () => {
    ...
    // state should be initialized from URL parts (and some propeties)
    assert.isTrue(spiedInit.called, 'The module state must be computed from URL at initialization')
    assert.equal(spiedInit.viewObjectType, DamDomain.ENTITY_TYPES_ENUM.DATA, 'DATASET view object type must be blocked when modules does not display datasets')
  ...
  it('should report URL changes to redux state', () => {
    ...
    assert.equal(spiedInit.viewObjectType, DamDomain.ENTITY_TYPES_ENUM.DATASET, 'The URL view object type change should be reported to redux state')
