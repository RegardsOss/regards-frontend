...
class DatabaseConnectionTester extends React.Component {
  ...
  render() {
    ...
    const testButton = <IconButton onTouchTap={this.handleTouchTap}>
      <PlayArrow/>
    </IconButton>

    const successButton = <span>
    ...
    const warningButton = <OnHoverSwitchIconButton
        tooltip="Restart"
        onTouchTap={this.handleTouchTap}
      >
    ...
    const errorButton = <OnHoverSwitchIconButton
        tooltip="Restart"
        onTouchTap={this.handleTouchTap}
      >
