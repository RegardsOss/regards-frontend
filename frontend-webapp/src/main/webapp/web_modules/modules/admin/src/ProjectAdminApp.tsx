 ...
 */
class ProjectAdminApp extends React.Component<ProjectAdminAppProps, any> {
  constructor () {
    super()
...
export default connect<{}, {}, ProjectAdminAppProps>(mapStateToProps, mapDispatchToProps)(ProjectAdminApp)
