...
class PluginConfigurationSelectors extends BasicPageableSelectors {
  constructor(type) {
    super(['admin', 'data-management', 'dataset', `plugin-configuration-${type}`])
  }
...
export const PluginConfigurationFiltersSelectors = new PluginConfigurationSelectors('filters')
export const PluginConfigurationConvertersSelectors = new PluginConfigurationSelectors('converters')
export const PluginConfigurationServicesSelectors = new PluginConfigurationSelectors('services')
