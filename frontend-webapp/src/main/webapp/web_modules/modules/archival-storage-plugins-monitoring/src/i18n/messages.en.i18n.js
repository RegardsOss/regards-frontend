...
const messages = {
  ...
  // bytes
  'archival.storage.capacity.monitoring.unit.o': 'o',
  'archival.storage.capacity.monitoring.unit.ko': 'Ko',
  'archival.storage.capacity.monitoring.unit.mo': 'Mo',
  'archival.storage.capacity.monitoring.unit.go': 'Go',
  'archival.storage.capacity.monitoring.unit.to': 'To',
  'archival.storage.capacity.monitoring.unit.po': 'Po',
  'archival.storage.capacity.monitoring.unit.eo': 'Eo',
  'archival.storage.capacity.monitoring.unit.zo': 'Zo',
  'archival.storage.capacity.monitoring.unit.yo': 'Yo',
  // bytes SI
  'archival.storage.capacity.monitoring.unit.kio': 'Kio',
  'archival.storage.capacity.monitoring.unit.mio': 'Mio',
  'archival.storage.capacity.monitoring.unit.gio': 'Gio',
  'archival.storage.capacity.monitoring.unit.tio': 'Tio',
  'archival.storage.capacity.monitoring.unit.pio': 'Pio',
  'archival.storage.capacity.monitoring.unit.eio': 'Eio',
  'archival.storage.capacity.monitoring.unit.zio': 'Zio',
  'archival.storage.capacity.monitoring.unit.yio': 'Yio',
}
