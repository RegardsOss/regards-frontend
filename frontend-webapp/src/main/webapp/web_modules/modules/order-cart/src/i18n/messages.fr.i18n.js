...
const messages = {
  ...
  'order-cart.module.objects.count.header.message': 'Le panier contient actuellement {effectiveObjectsCount} donnée(s) à commander.',
  ...
  'order-cart.module.duplicate.objects.message': 'Parmi les {totalObjectsCount} données ajoutées, {duplicatedObjectsCount} ont été ajoutées plusieurs fois. Par conséquent, seules {effectiveObjectsCount} données seront effectivement commandées',
