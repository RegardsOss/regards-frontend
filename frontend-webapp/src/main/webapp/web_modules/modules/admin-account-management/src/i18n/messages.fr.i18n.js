const messages = {
  ...
  'account.list.table.status.label.PENDING': 'En attente d\'accès',
  'account.list.table.status.label.ACCEPTED': 'Accepté',
  'account.list.table.status.label.ACTIVE': 'Actif',
  'account.list.table.status.label.LOCKED': 'Bloqué',
  'account.list.table.status.label.INACTIVE': 'Inactif',
