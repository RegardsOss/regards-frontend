# @regardsoss/admin-user-management

## Description

This module display REGARDS Users gateway panel to redirect to modules :
  - @regardsoss/admin-user-projectuser-management
  - @regardsoss/admin-user-role-management
