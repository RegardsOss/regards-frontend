...
const messages = {
  ...
  'data.board.collection.description': 'Les collections sont des regroupements de données par thématique',

  'data.board.datasource.title': 'Sources de données',
  'data.board.datasource.description': 'Les datasources retournent les données que vous souhaitez apporter à vos jeux de données',
