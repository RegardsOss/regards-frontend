# @regardsoss/admin-accessright-management

## Description

This module display REGARDS accessRights gateway panel to redirect to modules :
  - @regardsoss/admin-accessright-dataaccess-management
  - @regardsoss/admin-accessright-accessRights-management
