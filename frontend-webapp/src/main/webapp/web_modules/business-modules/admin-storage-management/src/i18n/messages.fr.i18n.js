...
const messages = Object.assign({
  ...
  'storage.security.configuration.title': 'Configuration de la sécurité',
  'storage.security.configuration.subtitle': 'Cette section vous permet de configurer la stratégie de sécurité',
  'storage.security.no.plugin.title': 'Aucun plugin de sécurité n\'est défini (TODO)',
  'storage.security.no.plugin.subtitle': 'L\'ingestion ne peut pas fonctionner tant qu\'aucun plugin de sécurité n\'aura été défini (TODO)',
  'storage.security.plugin.defined.title': 'Le plugin de sécurité est bien configuré (TODO)',
  'storage.security.plugin.defined.subtitle': 'L\'ingestion peut fonctionner (TODO)',
  'storage.security.too.many.plugin.title': 'Plusieurs plugin de sécurité sont configurés (TODO)',
  'storage.security.too.many.plugin.subtitle': 'Le système ne va pas indexer de données tant qu\'il y aura plusieurs plugins actifs (TODO)',
