# @regardsoss/admin-microservice-management

## Description

This module display REGARDS microservices configuration management panels.
...
This module is routed to the application by the main @regardsoss/admin module
