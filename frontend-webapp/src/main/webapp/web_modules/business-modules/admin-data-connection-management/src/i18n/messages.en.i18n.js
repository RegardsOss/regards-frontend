...
const messages = Object.assign({
  'connection.create.title': 'Create a new connection',
  ...
  'connection.form.user': 'User to use when connecting to the database',
  'connection.form.password': 'Password to use when connecting to the database',
  ...
  'connection.form.maxPoolSize': 'Maximum number of simultaneous connections (aka maxPoolSize)',
  'connection.form.minPoolSize': 'Number of simultaneous connections continuously maintained (aka minPoolSize)',
