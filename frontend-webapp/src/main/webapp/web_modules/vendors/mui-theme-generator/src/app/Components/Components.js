            ...
            <table style={{ width: "100%", tableLayout: "fixed", borderCollapse: "separate", borderSpacing: "0 2em" }}>
                <tbody>
                    ...
                    <ComponentWrapper title="Checkbox" >
                        ...
                        <Checkbox label="Checked" style={style.checkbox} checked={true} />
                        <Checkbox label="Disabled" style={style.checkbox} disabled={true} />
                    </ComponentWrapper>
                    ...
                    <ComponentWrapper title="RadioButton">
                        <RadioButtonGroup name="shipSpeed" defaultSelected={0}>
                            ...
                            <RadioButton value={2} label="Disabled" style={style.checkbox} disabled={true} />
                        </RadioButtonGroup>
                    </ComponentWrapper>

                    <ComponentWrapper title="Toggle">
                        <Toggle label="Simple" style={style.toggle} />
                        <Toggle label="Toggled by default" defaultToggled={true} style={style.toggle} />
                        <Toggle label="Disabled" disabled={true} style={style.toggle} />
                    </ComponentWrapper>
