...
import DataWithPictureOnlyComponent from '../components/DataWithPictureOnlyComponent'
 ...
 */
export class DataWithPictureOnlyContainer extends React.Component {
  /**
  ...
  static defaultProps = {
    state: DataWithPictureOnlyContainer.DEFAULT_STATE,
  }
  ...
  onToggled = () => {
    ...
    publishState(nextState, DataWithPictureOnlyContainer.convertToRequestParameters(nextState))
  }
...
export default DataWithPictureOnlyContainer
