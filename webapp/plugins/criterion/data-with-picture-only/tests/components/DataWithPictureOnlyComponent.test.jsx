...
/**
 * Test DataWithPictureOnlyComponent
 * @author Raphaël Mechali
 */
describe('[DATA WITH PICTURE ONLY criterion] Testing DataWithPictureOnlyComponent', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(DataWithPictureOnlyComponent)
  })
  it('should render correctly checked (french locale)', () => {
    ...
    const enzymeWrapper = shallow(<DataWithPictureOnlyComponent {...props} />, {
      context: {
        ...context,
        intl: {
          ...context.intl,
    ...
    testSuiteHelpers.assertWrapperProperties(checkbox, {
      ...
      title: 'criterion.data.with.picture.only.tooltip',
