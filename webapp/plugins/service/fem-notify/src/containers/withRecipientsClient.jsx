 ...
 **/
import { getRecipientsClient } from '../clients/RecipientsClient'
...
const withClient = (Component) => class WithClient extends React.Component {
  ...
  render() {
    ...
    const recipientsClient = getRecipientsClient(pluginInstanceId)
    return (
      <Component {...this.props} recipientsClient={recipientsClient} />
    )
  }
}
