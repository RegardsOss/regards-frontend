...
import { NotifyContainer } from '../../src/containers/NotifyContainer'
import styles from '../../src/styles/styles'

const context = buildTestContext(styles)

/**
 * Test case for {@link NotifyContainer}
 *
 * @author C-S
 */
describe('[fem-delete] Testing NotifyContainer', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)
  it('should exists', () => {
    assert.isDefined(NotifyContainer)
  })
  it('should render self and sub components', () => {
    ...
    shallow(<NotifyContainer {...props} />, { context })
  })
})
