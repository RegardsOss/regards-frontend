...
const actionsBuilder = (namespace) => {
  return new FemClient.RequestsActions(namespace)
}
const selectorsBuilder = (storePath) => {
  return FemClient.getRequestsSelectors(storePath)
}
const reducerBuilder = (namespace) => {
  return FemClient.getRequestsReducer(namespace)
}
