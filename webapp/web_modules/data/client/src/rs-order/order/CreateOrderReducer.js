 ...
 */
const getCreateOrderReducer = (namespace) => {
  const reducerInstance = new BasicSignalReducers(new CreateOrderActions(namespace))
  // reduce function
  return (state, action) => reducerInstance.reduce(state, action)
}

export default getCreateOrderReducer
