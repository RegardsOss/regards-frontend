 ...
 * @author Picart Kevin
 */
class StorageLocationCopyFilesActions extends BasicSignalActions {
  constructor(namespace) {
    super({
      namespace,
      entityEndpoint: `${GATEWAY_HOSTNAME}/${API_URL}/${STATIC_CONF.MSERVICES.STORAGE}/storages/files/copy`,
    })
  }
...
export default StorageLocationCopyFilesActions
