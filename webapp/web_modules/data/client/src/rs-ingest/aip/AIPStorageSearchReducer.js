...
import AIPStorageSearchActions from './AIPStorageSearchActions'
 ...
 * @author Simon MILHAU
 */
class AIPStorageSearchReducer extends BasicArrayReducers {
  constructor(namespace) {
    super(new AIPStorageSearchActions(namespace))
  }
}

export default (namespace) => {
  const instance = new AIPStorageSearchReducer(namespace)
