 ...
 */
export default class UpdateRequestActions extends BasicInfosPageableActions {
  /**
   * Construtor
   * @param namespace
   */
  constructor(namespace) {
    super({
      namespace,
      entityEndpoint: `${GATEWAY_HOSTNAME}/${API_URL}/${STATIC_CONF.MSERVICES.FEM}/requests/search/UPDATE`,
      schemaTypes: {
        ENTITY: REQUEST_FEM,
