 ...
 */
export default class NotificationRequestActions extends BasicInfosPageableActions {
  /**
   * Construtor
   * @param namespace
   */
  constructor(namespace) {
    super({
      namespace,
      entityEndpoint: `${GATEWAY_HOSTNAME}/${API_URL}/${STATIC_CONF.MSERVICES.FEM}/requests/search/NOTIFICATION`,
      schemaTypes: {
        ENTITY: REQUEST_FEM,
