...
export default {
  content: [
    {
      ...
      links: [{ rel: 'list', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains' } }, { rel: 'self', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/1', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/1' } }, { rel: 'update', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/1', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/1' } }, { rel: 'start', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/1/start', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/1/start' } }, { rel: 'stop', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/1/stop', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/1/stop' } }],
    }, {
      content: {
        id: 2,
        label: 'tototo',
      ...
      links: [{ rel: 'list', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains' } }, { rel: 'self', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/2', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/2' } }, { rel: 'update', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/2', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/2' } }, { rel: 'delete', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/2', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/2' } }, { rel: 'stop', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/2/stop', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains/2/stop' } }],
    },
  ],
  metadata: {
    size: 100,
  ...
  links: [{ rel: 'self', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains?page\u003d0\u0026size\u003d100', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-dataprovider/chains?page\u003d0\u0026size\u003d100' } }],
}
