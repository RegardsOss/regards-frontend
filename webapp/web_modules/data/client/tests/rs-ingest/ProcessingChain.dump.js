...
export default {
  ...
  content: [
    {
      ...
      links: [{ rel: 'self', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-ingest/processingchains/ma_premiere_chaine', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-ingest/processingchains/ma_premiere_chaine' } }, { rel: 'delete', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-ingest/processingchains/ma_premiere_chaine', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-ingest/processingchains/ma_premiere_chaine' } }, { rel: 'update', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-ingest/processingchains/ma_premiere_chaine', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-ingest/processingchains/ma_premiere_chaine' } }],
    }, {
      content: {
        id: 52,
  ...
  links: [{ rel: 'self', href: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-ingest/processingchains?page\u003d0\u0026size\u003d100', template: { variables: { variables: [] }, baseUri: 'http://vm-perf.cloud-espace.si.c-s.fr/api/v1/rs-ingest/processingchains?page\u003d0\u0026size\u003d100' } }],
}
