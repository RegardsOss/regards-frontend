...
export default [
  {
    ...
    links: [{ rel: 'self', href: 'http://vm-pre-prod.cloud-espace.si.c-s.fr/api/v1/rs-ingest/plugins/FullPluginExample/config/202', template: { variables: { variables: [] }, baseUri: 'http://vm-pre-prod.cloud-espace.si.c-s.fr/api/v1/rs-ingest/plugins/FakeSipValidation/config/202' } }, { rel: 'delete', href: 'http://vm-pre-prod.cloud-espace.si.c-s.fr/api/v1/rs-ingest/plugins/FakeSipValidation/config/202', template: { variables: { variables: [] }, baseUri: 'http://vm-pre-prod.cloud-espace.si.c-s.fr/api/v1/rs-ingest/plugins/FakeSipValidation/config/202' } }, { rel: 'update', href: 'http://vm-pre-prod.cloud-espace.si.c-s.fr/api/v1/rs-ingest/plugins/FakeSipValidation/config/202', template: { variables: { variables: [] }, baseUri: 'http://vm-pre-prod.cloud-espace.si.c-s.fr/api/v1/rs-ingest/plugins/FakeSipValidation/config/202' } }, { rel: 'list', href: 'http://vm-pre-prod.cloud-espace.si.c-s.fr/api/v1/rs-ingest/plugins/FakeSipValidation/config', template: { variables: { variables: [] }, baseUri: 'http://vm-pre-prod.cloud-espace.si.c-s.fr/api/v1/rs-ingest/plugins/FullPluginExample/config' } }],
  },
  {
    content: {
      id: 40,
