...
export default class LocalStorageData {
   ...
   */
  static getLocalStorageKey(application = 'user', project = 'instance', moduleId, elementName) {
   ...
   */
  static getData(application = 'user', project, moduleId, elementName) {
   ...
   * @param {string} elementName logical name of the data related elements
   */
  static saveData(application = 'user', project, moduleId, elementName, data) {
   ...
   * @param {string} elementName logical name of the data related elements
   */
  static clearData(application = 'user', project, moduleId, elementName) {
