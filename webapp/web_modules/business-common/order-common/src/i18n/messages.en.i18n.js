...
const messages = {
  ...
  'order.list.option.cell.retry.mode.selection.title' : 'Restart Order - {name}',
  'order.list.options.retry.retry.label': 'Retry order errors',
  'order.list.options.retry.restart.label': 'Restart full order',
