...
const messages = {
  ...
  'order.list.refresh.auto.label': 'Rafraîchissement Auto',
  ...
  'order.list.column.id': 'Identifiant',
  'order.list.column.options': 'Options',
  'order.list.cell.status.PENDING': 'En attente',
  'order.list.cell.status.RUNNING': 'En cours',
  'order.list.cell.status.PAUSED': 'En pause',
  'order.list.cell.status.EXPIRED': 'Expirée',
  'order.list.cell.status.FAILED': 'Echec',
  'order.list.cell.status.DONE_WITH_WARNING': 'Terminée avec warning',
  'order.list.cell.status.DONE': 'Terminée',
  'order.list.cell.status.DELETED': 'Supprimée',
  ...
  'order.list.option.cell.show.processing.order.tooltip': 'Afficher les traitements',
  'order.list.option.cell.show.processing.dialog.title': 'Traitements de {orderName}',
  'order.list.option.cell.show.processing.dialog.dataset.title': 'Jeux de données :',
  'order.list.option.cell.show.processing.dialog.button.close': 'Fermer',
  ...
  'datasets.list.column.fileFilters': 'Filtres',
  ...
  'datasets.list.column.fileFilters.fileNamePattern.label': 'Nom',
