...
const messages = {
  ...
  'error.message.module.subtitle.four': 'Enfin, il est également listé les configurations qui utilisent dans le cadre des Filtres des attributs de type INTEGER ou LONG. Vous devez les enlever.',
