...
describe('[Components] Testing URLSVGPicture', () => {
  ...
  it('should render correctly', () => {
    ...
    assert.equal(svgRenderWrapper.props().style.width, 250, 'Styles should be correctly merged with user styles')
    assert.equal(svgRenderWrapper.props().style.fill, props.color, 'SVG props should be correctly reported in style')
    assert.isOk(svgRenderWrapper.props().style.height, 'Missing styles should be completed from theme')
  })
})
