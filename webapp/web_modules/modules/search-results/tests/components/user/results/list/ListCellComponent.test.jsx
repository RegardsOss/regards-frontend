...
import ListCellComponent from '../../../../../src/components/user/results/list/ListCellComponent'
...
import EntityDescriptionComponent from '../../../../../src/components/user/results/common/options/EntityDescriptionComponent'
import SearchRelatedEntitiesComponent from '../../../../../src/components/user/results/common/options/SearchRelatedEntitiesComponent'
import OneElementServicesContainer from '../../../../../src/containers/user/results/common/options/OneElementServicesContainer'
import AddElementToCartContainer from '../../../../../src/containers/user/results/common/options/AddElementToCartContainer'
import styles from '../../../../../src/styles'
import {
  dataEntityWithServices, dataEntity, datasetEntity, documentEntity,
...
describe('[SEARCH RESULTS] Testing ListCellComponent', () => {
  ...
  const testCases = [{
    ...
    label: 'documents (without selection, service, description, cart, download, enableSearch)',
