...
import TypeTabContainer from '../../../../../src/containers/user/results/header/options/TypeTabContainer'
import ToggleFiltersContainer from '../../../../../src/containers/user/results/header/options/ToggleFiltersContainer'
import ModeSelectorContainer from '../../../../../src/containers/user/results/header/options/ModeSelectorContainer'
import SelectAllContainer from '../../../../../src/containers/user/results/header/options/SelectAllContainer'
...
import SelectionServiceComponent from '../../../../../src/components/user/results/header/options/SelectionServiceComponent'
import AddSelectionToCartComponent from '../../../../../src/components/user/results/header/options/AddSelectionToCartComponent'
