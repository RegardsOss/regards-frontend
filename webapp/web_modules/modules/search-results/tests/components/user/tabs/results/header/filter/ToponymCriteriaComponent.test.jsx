...
/**
 * Test ToponymCriteriaComponent
 * @author Théo Lasserre
 */
describe('[SEARCH RESULTS] Testing ToponymCriteriaComponent', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(ToponymCriteriaComponent)
  })
  it('should render correctly', () => {
    ...
    const enzymeWrapper = shallow(<ToponymCriteriaComponent {...props} />, { context })
    ...
    testSuiteHelpers.assertWrapperProperties(delegateWrapper, {
      label: props.label,
      onUnselectCriterion: props.onUnselectToponymCriteria,
