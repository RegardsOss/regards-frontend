...
import SearchPaneComponent from '../../../../../../src/components/user/tabs/results/search/CriterionWrapperComponent'
...
describe('[SEARCH RESULTS] Testing CriterionWrapperContainer', () => {
  ...
  it('should render correctly', () => {
    ...
    const componentWrapper = enzymeWrapper.find(SearchPaneComponent)
