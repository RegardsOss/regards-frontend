...
class SelectedStringFacetComponent extends React.Component {
  static propTypes = {
    selectedFacetValue: UIShapes.SelectedStringFacetCriterion.isRequired,
  ...
  buildLabel = () => {
    ...
    return formatMessage({ id: 'search.facets.filter.chip.word.value' }, { facetLabel: attributeLabel, word: facetValue })
  }
