...
This module is a dynamic configurable module to be used in REGARDS user interfaces. It loads [Mizar](https://github.com/MizarWeb/MizarWidget/) in an IFrame container to embed a map inside REGARDS. Using OpenSearch search engine, it retrieves all dataset the user has access to and let the user navigate across all data.
