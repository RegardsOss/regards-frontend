...
import DeleteDatasetSelectionComponent, { IconButtonWithConfirmDialog } from '../../../../src/components/user/options/DeleteDatasetSelectionComponent'
import styles from '../../../../src/styles/styles'

const context = buildTestContext(styles)

/**
* Test DeleteDatasetSelectionComponent
* @author Raphaël Mechali
*/
describe('[Order Cart] Testing DeleteDatasetSelectionComponent', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(DeleteDatasetSelectionComponent)
  })
