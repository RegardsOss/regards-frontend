...
describe('[Order Cart] Testing OrderCartTableComponent', () => {
  ...
  const testCases = [{
    ...
    caseLabel: 'when hiding processing column (hiding quota & hiding datasets)',
    props: {
      basket: mockBasket1,
      quotaInfo: {
        currentQuota: 250,
    ...
    caseLabel: 'when hiding processing column (showing quota & hiding datasets)',
    props: {
      basket: mockBasket1,
      quotaInfo: {
        currentQuota: 505,
    ...
    caseLabel: 'when hiding processing column (hiding quota & showing datasets)',
    props: {
      basket: mockBasket1,
      quotaInfo: {
        currentQuota: 250,
    ...
    caseLabel: 'when hiding processing column (showing quota & showing datasets)',
    props: {
      basket: mockBasket1,
      quotaInfo: {
        currentQuota: 505,
    ...
    caseLabel: 'when hiding filters column (hiding quota & hiding datasets)',
    props: {
      basket: mockBasket1,
      quotaInfo: {
        currentQuota: 250,
    ...
    caseLabel: 'when hiding filters column (showing quota & hiding datasets)',
    props: {
      basket: mockBasket1,
      quotaInfo: {
        currentQuota: 505,
    ...
    caseLabel: 'when hiding filters column (hiding quota & showing datasets)',
    props: {
      basket: mockBasket1,
      quotaInfo: {
        currentQuota: 250,
    ...
    caseLabel: 'when hiding filters column (showing quota & showing datasets)',
    props: {
      basket: mockBasket1,
      quotaInfo: {
        currentQuota: 505,
  ...
  testCases.forEach(({
    caseLabel,
    props: {
      basket, quotaInfo, showDatasets, showProcessings, showFilters,
    }, expectedRows,
  }) => it(`should render correctly ${caseLabel}`, () => {
    const props = {
      basket,
      refreshBasket: () => { },
      showDatasets,
