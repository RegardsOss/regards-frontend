...
const messages = {
  ...
  'menu.form.selectMainServiceTitle.fr': 'Titre de la page du service de connexion principal en français',
  'menu.form.selectMainServiceTitle.en': 'Titre de la page du service de connexion principal en anglais',
  'menu.form.selectMainService.show.subtitle': 'Afficher le sous titre de la page du service de connexion principal',
