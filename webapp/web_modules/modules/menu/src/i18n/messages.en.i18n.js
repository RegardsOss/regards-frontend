...
const messages = {
  ...
  'menu.form.projectpage.title.fr': 'Page title in french',
  'menu.form.projectpage.title.en': 'Page title in english',
  'menu.form.displayauthentication': 'Display authentication option',
  'menu.form.selectMainService': 'Main connection service',
  'menu.form.selectMainServiceTitle.fr': 'Main connection service page title in french',
  'menu.form.selectMainServiceTitle.en': 'Main connection service page title in english',
  'menu.form.selectMainService.show.subtitle': 'Show subtitle of the main connection service page',
