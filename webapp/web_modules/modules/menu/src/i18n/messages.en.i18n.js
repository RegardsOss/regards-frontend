...
const messages = {
  ...
  'user.profile.quota.info.message.remaining.downloads': '{remainingQuota}/{maxQuota} remaining download(s)',
  'user.profile.quota.info.message.unlimited.rate': 'Your simultaneous downloads are not limited',
  'user.profile.quota.info.message.remaining.rate': '{currentRate}/{rateLimit} simultaneous downloads',
