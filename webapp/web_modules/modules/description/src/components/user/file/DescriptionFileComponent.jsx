            ...
            <div style={rootStyle} {...bind('measureDiv')}>
              {
                (function renderContent() {
                  if (loading) {
                    return <LoadingDisplayerComponent message={formatMessage({ id: 'module.description.description.loading' })} />
                  }
                  ...
                  return (
                    <NoContentMessageInfo
                      noContent
                      title={noContentTitle || formatMessage({ id: 'module.description.description.no.value.title' })}
                      message={noContentMessage || formatMessage({ id: 'module.description.description.no.value.message' })}
                      Icon={NoDataIcon}
                    >
                      <div />
                    </NoContentMessageInfo >)
