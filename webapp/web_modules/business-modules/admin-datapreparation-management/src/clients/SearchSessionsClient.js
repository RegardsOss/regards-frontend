 ...
 */
const ENTITIES_STORE_PATH = ['admin', 'acquisition', 'dataPreparation', 'searchSessions']
const REDUX_ACTION_NAMESPACE = 'admin-datapreparation-management/search-sessions'
