...
/**
 * Delete request component option
 * @author Théo Lasserre
 */
class DeleteRequestComponent extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <HateoasIconAction
        disabled={isLoading}
        title={formatMessage({ id: 'datapreparation.table.actions.delete.tooltip' })}
