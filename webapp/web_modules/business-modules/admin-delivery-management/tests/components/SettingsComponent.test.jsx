 ...
 */
describe('[ADMIN DELIVERY MANAGEMENT] Testing SettingsComponent', () => {
  ...
  it('should render correctly and initialize form value', () => {
    ...
    assert.deepEqual(spiedInitializedData, {
      [SETTINGS.S3_SERVER]: getValue(props.settings, SETTINGS.S3_SERVER),
    ...
    testSuiteHelpers.assertWrapperProperties(cardActionsWrapper, {
      mainButtonLabel: 'delivery.settings.action.confirm',
      ...
      secondaryButtonLabel: 'delivery.settings.action.cancel',
