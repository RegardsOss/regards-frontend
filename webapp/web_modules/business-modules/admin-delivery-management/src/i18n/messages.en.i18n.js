...
const messages = {
  ...
  'delivery.settings.field.request_ttl': 'Time in seconds before a delivery request expires',
  'delivery.settings.field.build_bucket': 'Bucket on which the files will be deposited during the construction of the command',
  'delivery.settings.field.delivery_bucket': 'Bucket on which the delivery ZIP archives will be deposited once the orders have been completed',
  'delivery.settings.field.s3_server': 'S3 Server',
  'delivery.settings.field.s3_server.host': 'S3 server access address',
