...
const messages = Object.assign({
  ...
  'sips.list.table.headers.providerId': 'Identifiant fournisseur',
  ...
  'sips.session.table.headers.errors': 'Erreurs',
  ...
  'sips.session.table.actions.retry': 'Soumettre à nouveau les SIPs de la session',
