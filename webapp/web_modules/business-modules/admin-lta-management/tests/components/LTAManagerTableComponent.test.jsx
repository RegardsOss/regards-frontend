...
/**
 * Test LTAManagerTableComponent
 * @author Théo Lasserre
 */
describe('[ADMIN LTA MANAGEMENT] Testing LTAManagerTableComponent', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(LTAManagerTableComponent)
  })
  it('should render correctly', () => {
    ...
    const enzymeWrapper = shallow(<LTAManagerTableComponent {...props} />, { context })
