...
import ViewMessageDialog from '../../../src/components/dialog/ViewMessageDialog'
import styles from '../../../src/styles'

const context = buildTestContext(styles)

/**
 * Test ViewMessageDialog
 * @author Théo Lasserre
 */
describe('[ADMIN LTA MANAGEMENT] Testing ViewMessageDialog', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(ViewMessageDialog)
  })
  it('should render correctly', () => {
    ...
    const enzymeWrapper = shallow(<ViewMessageDialog {...props} />, { context })
