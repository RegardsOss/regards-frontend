...
/**
  ...
  */
export class ViewProductDialog extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <Dialog
        title={intl.formatMessage({ id: 'lta.table.actions.view.product.title' })}
        open
      >
        <Card>
          <CardMedia>
            <CodeFileDisplayer
              content={JSON.stringify(entity.content.product, null, '\t')}
