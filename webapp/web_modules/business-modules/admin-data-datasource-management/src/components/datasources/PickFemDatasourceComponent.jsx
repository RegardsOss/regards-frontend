...
export class PickFemDatasourceComponent extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div style={pluginWrapper}>
        ...
        {formatMessage({ id: 'datasource.form.create.pick-interface.description.feature' })}
        <Link to={url}>
          <RaisedButton
...
export default withResourceDisplayControl(PickFemDatasourceComponent)
