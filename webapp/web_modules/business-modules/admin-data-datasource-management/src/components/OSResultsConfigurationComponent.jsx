 ...
 */
class OSResultsConfigurationComponent extends React.Component {
static propTypes = {
...
static defaultProps = {}
  ...
  render() {
    return (<Card>
      <CardTitle
        title="Create the results"
        subtitle="Results stuff"
      />
...
export default OSResultsConfigurationComponent
