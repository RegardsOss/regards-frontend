...
const messages = {
  ...
  'crawler.list.cursor.lastEntityDate.column.header': 'Date dernière entité aspirée',
  ...
  'crawler.list.current.button': 'Index courant ({count})',
  'crawler.list.building.button': 'Index en cours de réindexation ({count})',
  'crawler.list.refresh.button': 'Rafraîchir',
  'crawler.list.warning.message': 'Réindexation en cours',
  ...
  'crawler.list.schedule.action': 'Programmer une aspiration',
  'crawler.list.scheduled': 'La date de prochaine aspiration a été mise à jour',
  'crawler.list.scheduled.dialog.title': 'Continuer l\'aspiration',
  'crawler.list.scheduled.dialog.button.close': 'Fermer',
  'crawler.list.scheduled.dialog.button.continue': 'Continuer',
  'crawler.list.scheduled.dialog.date': 'Date',
  'crawler.list.scheduled.dialog.time': 'Heure',
  'crawler.list.scheduled.dialog.message': 'Vous pouvez continuer l\'aspiration à partir de la date ci-dessous, cette date doit être inférieure à la date de la dernière entité aspirée. Si aucune date n\'est définie alors l\'aspiration continuera depuis la date de la dernière entité aspirée.',
  ...
  'datasource.form.subsettingCategories': 'Aspirer uniquement les données de certaines catégories (opérateur OU entre catégories - vide = toutes les catégories de données sont aspirées)',
