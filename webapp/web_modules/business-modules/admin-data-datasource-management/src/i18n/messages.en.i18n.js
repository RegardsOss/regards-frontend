...
const messages = {
  ...
  'crawler.list.cursor.lastEntityDate.column.header': 'Last entity ingested date',
  ...
  'crawler.list.current.button': 'Current index ({count})',
  'crawler.list.building.button': 'Building index ({count})',
  'crawler.list.refresh.button': 'Refresh',
  'crawler.list.warning.message': 'Reindexing in progress',
  ...
  'crawler.list.schedule.action': 'Schedule an aspiration',
  'crawler.list.scheduled': 'The aspiration date has been updated',
  'crawler.list.scheduled.dialog.title': 'Continue aspiration',
  'crawler.list.scheduled.dialog.button.close': 'Close',
  'crawler.list.scheduled.dialog.button.continue': 'Continue',
  'crawler.list.scheduled.dialog.date': 'Date',
  'crawler.list.scheduled.dialog.time': 'Time',
  'crawler.list.scheduled.dialog.message': 'You can continue the aspiration from the date below, this date must be less than the date of the last aspirated entity. If no date is set then the aspiration will continue from the date of the last aspirated entity.',
  ...
  'datasource.form.mapping.aspiration.mode.none.subtitle': 'Each time the crawler passes, all data will be processed. This option is not recommended because it is very time consuming.',
  ...
  'datasource.form.mapping.aspiration.mode.byId.subtitle': 'The crawler will only process data whose identifier is greater than data already processed.',
  ...
  'datasource.form.mapping.aspiration.mode.byId.non.uniq.warning': 'If this box is checked, the number of crawled entities display on the Dashboard will be greater than the actual number of entities in the catalog.',
