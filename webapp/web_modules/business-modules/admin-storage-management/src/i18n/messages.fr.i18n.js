...
const messages = Object.assign({
  ...
  'storage.data-storage.plugins.list.header.type.label': 'Mode de stockage',
  ...
  'storage.plugins.storage.form.edit.title': 'Édition de l\'espace de stockage "{name}"',
  'storage.plugins.storage.form.create.subtitle': 'Après avoir sélectionné le mode de stockage désiré, veuillez renseigner les paramètres de configuration associés.',
