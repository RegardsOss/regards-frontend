...
const messages = {
  ...
  'storage.location.type.pending.name': 'Lancer les actions en attente : ',
  ...
  'storage.location.type.pending.description': 'Permet de lancer les actions en attente sur les divers espaces de stockage. Cette action est automatiquement réalisée de manière périodique, vous pouvez lancer cette action en appuyant sur ce bouton.',
  ...
  'storage.location.list.delete.storage': 'Forcer la suppression des fichiers en erreur',
  ...
  'storage.location.errors.delete.confirm.title': 'Forcer la suppression des fichiers en erreur du stockage {name} ?',
  ...
  'storage.location.delete.confirm.message.force.option': 'Par défaut seuls les fichiers expirés du cache seront supprimés. Souhaitez-vous :',
  'storage.location.delete.confirm.option': 'Ignorer les erreurs de suppression des fichiers physiques ?',
  'storage.location.delete.confirm.force.option': 'Supprimer également les fichiers qui n\'ont pas atteint leur date d\'expiration ? (Attention : Les commandes utilisateurs associées à ces fichiers ne seront plus téléchargeables)',
  ...
  'storage.data-storage.waiting.actions.button': 'Lancer les actions en attente',
  ...
  'storage.settings.fieldgroup.file.title': 'Paramètres de stockage des fichiers téléversés pour les jeux de données et les collections',
