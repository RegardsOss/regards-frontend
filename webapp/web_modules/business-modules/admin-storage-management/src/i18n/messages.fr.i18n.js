...
const messages = Object.assign({
  ...
  'storage.data-storage.plugins.list.copy.button': 'Copier les fichiers vers un autre storage',
  'storage.data-storage.plugins.list.delete-files.button': 'Effacer les fichiers du storage',
  ...
  'storage.data-storage.plugins.list.delete.storage': 'Supprimer les erreurs de stockage',
  'storage.data-storage.plugins.list.delete.deletion': 'Supprimer les erreurs de suppression',
  'storage.data-storage.plugins.delete.confirm.title': 'Suppression des fichiers du stockage {name} ?',
  'storage.data-storage.plugins.errors.delete.confirm.title': 'Suppression des erreurs du stockage {name} ?',
  'storage.data-storage.plugins.errors.relaunch.confirm.title': 'Relance des erreurs du stockage {name} ?',
  ...
  'storage.data-storage.plugins.copy.confirm.title': 'Copier les fichiers du storage {name} vers...',
  'storage.data-storage.plugins.copy.confirm.path-destination': 'Répertoire de destination (optionnel)',
  'storage.data-storage.plugins.copy.confirm.path-source': 'Répertoire d\'origine à copier (optionnel)',
