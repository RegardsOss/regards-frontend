...
const messages = Object.assign({
  ...
  'storage.data-storage.plugins.online.list.subtitle': 'Online storages are systems where datas are directly available and so can be directly downloaded.',
  ...
  'storage.security-delegation.list.add.button': 'Add a new strategy',
  ...
  'storage.plugins.security.form.create.title': 'Add a new access rights strategy',
