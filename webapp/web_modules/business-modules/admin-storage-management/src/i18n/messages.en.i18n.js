...
const messages = {
  ...
  'storage.location.type.pending.name': 'Run pending actions : ',
  ...
  'storage.location.type.pending.description': 'Allow you to run pending actions on the various storage spaces. This action is automatically carried out periodically but you can trigger it on demand using this button.',
  ...
  'storage.location.list.delete.storage': 'Force delete error files',
  ...
  'storage.location.errors.delete.confirm.title': 'Force delete error files of {name} ?',
  ...
  'storage.location.delete.confirm.message.force.option': 'By default only expired cache files will be deleted. Would you like to:',
  'storage.location.delete.confirm.option': 'Ignore error during physical deletion ?',
  'storage.location.delete.confirm.force.option': 'Also delete files that have not reached their expiration date? (Warning: The user commands associated with these files will no longer be downloadable)',
  ...
  'storage.data-storage.waiting.actions.button': 'Run pending actions',
