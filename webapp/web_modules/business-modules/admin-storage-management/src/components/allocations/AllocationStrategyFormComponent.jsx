...
*/
export class AllocationStrategyFormComponent extends React.Component {
  static propTypes = {
  ...
  renderContent = (pluginConfiguration, selectedPluginId) => {
    ...
    return (
      <div>
        <PluginListContainer
          title={formatMessage({ id: 'storage.plugins.allocation.form.type.select.title' })}
          selectLabel={formatMessage({ id: 'storage.plugins.allocation.form.type.select.label' })}
  ...
  render() {
    ...
    const title = mode === 'edit'
      ? formatMessage({ id: 'storage.plugins.allocation.form.edit.title' }, { name: get(pluginConfiguration, 'content.label', '<>') })
      : formatMessage({ id: 'storage.plugins.allocation.form.create.title' })
    const subtitle = mode === 'edit'
      ? formatMessage({ id: 'storage.plugins.allocation.form.edit.subtitle' })
      : formatMessage({ id: 'storage.plugins.allocation.form.create.subtitle' })
    return (
      <Card>
        <CardTitle
          title={title}
...
export default withModuleStyle(styles)(withI18n(messages)(AllocationStrategyFormComponent))
