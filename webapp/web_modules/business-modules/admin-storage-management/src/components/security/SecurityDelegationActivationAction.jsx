...
/**
* Custom cell for SecurityDelegationListComponent infinite table to render specific action on active property
* @author Sébastien Binda
*/
class SecurityDelegationActivationAction extends React.Component {
  static propTypes = {
...
export default SecurityDelegationActivationAction
