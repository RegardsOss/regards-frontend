...
import SecurityDelegationEditAction from './SecurityDelegationEditAction'
import SecurityDelegationActivationAction from './SecurityDelegationActivationAction'
...
*/
export class SecurityDelegationListComponent extends React.Component {
    ...
    if (entitytoDelete) {
      ...
      return (
        <ConfirmDialogComponent
          ...
          title={this.context.intl.formatMessage({ id: 'storage.security-delegation.plugins.list.confirm.delete.title' }, { name })}
      ...
      <Card>
        ...
        <CardActions>
          <CardActionsComponent
            mainButtonLabel={formatMessage({ id: 'storage.security-delegation.list.add.button' })}
            mainButtonClick={onAddNewConf}
            mainHateoasDependencies={SecurityDelegationListComponent.addDependencies}
...
export default withModuleStyle(styles)(withI18n(messages)(SecurityDelegationListComponent))
