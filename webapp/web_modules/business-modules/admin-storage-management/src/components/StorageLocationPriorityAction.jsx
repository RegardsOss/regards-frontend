...
*/
class StorageLocationPriorityAction extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <IconButton
        ...
        title={title}
        iconStyle={StorageLocationPriorityAction.iconStyle}
        style={StorageLocationPriorityAction.buttonStyle}
...
export default StorageLocationPriorityAction
