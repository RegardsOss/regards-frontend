 ...
 */
describe('[ADMIN FEATURE MANAGEMENT] Testing HeaderActionsBarContainer', () => {
  ...
  it('should render correctly', () => {
    ...
    assert.lengthOf(enzymeWrapper.find(HeaderActionsBarComponent), 1, 'HeaderActionsBarComponent should be set')
  })
})
