...
import {
  FiltersPaneMainComponent, FilterPaneDatePickerField, FilterPaneTextFieldValues, FilterPaneSelectField, FilterPaneAutoCompleteField,
...
/**
 * Test RequestManagerFiltersComponent
 * @author Théo Lasserre
 */
describe('[ADMIN FEATURE MANAGEMENT] Testing RequestManagerFiltersComponent', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(RequestManagerFiltersComponent)
  })
  it('should render correctly', () => {
    const props = {
      inputValues: RequestManagerFiltersComponent.DEFAULT_FILTERS_STATE,
      updateFilter: () => { },
      updateValuesFilter: () => { },
      updateDatesFilter: () => { },
      isPaneOpened: true,
