...
const featureManagementReducer = combineReducers({
  ...
  extractionRequestsTable: extractionRequestsTableReducer,
  creationRequests: creationRequestReducer,
  creationRequestsTable: creationRequestsTableReducer,
  updateRequests: updateRequestReducer,
  updateRequestsTable: updateRequestsTableReducer,
  deleteRequests: deleteRequestReducer,
  deleteRequestsTable: deleteRequestsTableReducer,
  notificationRequests: notificationRequestReducer,
  notificationRequestsTable: notificationRequestsTableReducer,
})
