...
const messages = {
  ...
  'feature.references.list.filters.date.label': 'Date',
  'feature.references.list.filters.time.label': 'Hour',
  ...
  'feature.requests.list.filters.dissemination.status': 'Dissemination',
  ...
  'feature.requests.dissemination.status.any': 'All state',
  'feature.requests.dissemination.status.PENDING': 'Pending',
  'feature.requests.dissemination.status.DONE': 'Done',
