...
const messages = {
  ...
  'feature.references.list.filters.time.label': 'Heure',
  ...
  'feature.requests.status.any': 'Tous les statuts',
  'feature.requests.status.GRANTED': 'ACCEPTE',
  'feature.requests.status.DENIED': 'REFUSE',
  'feature.requests.status.ERROR': 'ERREUR',
  'feature.requests.dissemination.status.any': 'Tous les statuts',
  'feature.requests.dissemination.status.PENDING': 'En cours',
  'feature.requests.dissemination.status.DONE': 'Terminé',
