...
const messages = {
  ...
  'processing-chain.info.message.step4': '4 - [Metadonnées de stockage] Mise à jour des moyens de stockage à utiliser',
  'processing-chain.info.message.step5': '5 - [Tagging AIP(s)] Ajout de tags sur les AIP générés',
  'processing-chain.info.message.step6': '6 - [Post-traitement] Action de post-traitement quelconque en fonction du SIP',
  ...
  'processing-chain.form.storage_metadata_update.plugin.label': 'Metadonnées de stockage',
