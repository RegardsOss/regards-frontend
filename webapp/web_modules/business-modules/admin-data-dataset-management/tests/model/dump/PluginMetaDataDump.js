...
export default {
  aComplexErrorPlugin: {
    content: {
      ...
      interfaceClassName: ['fr.cnes.regards.framework.plugins.ISamplePlugin', 'fr.cnes.regards.framework.plugins.IComplexInterfacePlugin'],
      author: 'CSSI',
      version: '0.0.1',
  ...
  aSamplePlugin: {
    content: {
      ...
      interfaceClassName: ['fr.cnes.regards.framework.plugins.ISamplePlugin'],
      author: 'CSSI',
