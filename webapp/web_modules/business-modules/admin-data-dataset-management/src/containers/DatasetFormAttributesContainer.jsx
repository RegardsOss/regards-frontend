...
export class DatasetFormAttributesContainer extends React.Component {
  ...
  onSubmit = (values) => {
    ...
    this.props.handleSave(values.providerId, values.label, values.geometry, values.model, properties, datasourceObjectModelName, values.descriptionFileContent, values.descriptionUrl)
  }
