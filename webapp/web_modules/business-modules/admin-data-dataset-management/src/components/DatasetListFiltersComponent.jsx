 ...
 */
class DatasetListFiltersComponent extends React.Component {
  static propTypes = {
          ...
          <TableHeaderOptionGroup>
            <TextField
              hintText={this.context.intl.formatMessage({
                id: 'dataset.table.filter.dataset.label',
              })}
            ...
            <FlatButton
              label={this.context.intl.formatMessage({
                id: 'dataset.table.filter.clear.button',
              })}
              icon={<Close />}
              onClick={this.handleClearFilters}
            />
            <FlatButton
              label={this.context.intl.formatMessage({ id: 'dataset.table.filter.button' })}
              icon={<Filter />}
...
export default DatasetListFiltersComponent
