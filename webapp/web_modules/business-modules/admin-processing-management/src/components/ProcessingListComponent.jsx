...
import { CardActionsComponent, 
    ShowableAtRender, 
    ConfirmDialogComponentTypes,
    TableHeaderOptionsArea,
    NoContentComponent, TableLayout, 
    TableHeaderLineLoadingAndResults, TableHeaderLine, 
...
class ProcessingListComponent extends React.Component {
    ...
    render() {
        const {
            entities, handleEdit, handleDelete, createUrl, backUrl, onRefresh, navigateToCreateProcessing,
        } = this.props
        ...
        new TableColumnBuilder('column.options')
            ...
            optionProps: { handleEdit: handleEdit, hoverColor: style.hoverButtonEdit },
        }, {
