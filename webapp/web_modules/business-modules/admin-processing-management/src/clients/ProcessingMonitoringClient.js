...
/**
 * Processing Monitor entities client.
 * @author Théo Lasserre
 */
const ENTITIES_STORE_PATH = ['admin', 'processing', 'processing-monitor']
...
export const processingMonitoringActions = new ProcessingMonitoringActions(REDUX_ACTION_NAMESPACE)
export const processingMonitoringSelectors = getProcessingMonitoringSelectors(ENTITIES_STORE_PATH)
