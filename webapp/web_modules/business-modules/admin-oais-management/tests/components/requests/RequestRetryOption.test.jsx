...
import RequestRetryOption from '../../../src/components/requests/RequestRetryOption'
 ...
 * @author Simon MILHAU
 */
describe('[OAIS AIP MANAGEMENT] Testing RequestRetryOption', () => {
  ...
  it('should render correctly', () => {
    ...
    const props = {
      entity: Request,
      onRetry: () => { spiedCallbackData.count += 1 },
    }
