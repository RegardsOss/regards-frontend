...
describe('[OAIS MANAGEMENT] Testing router', () => {
  ...
  it('should return the correct value', () => {
    ...
    expect(Routes.childRoutes[2].path).to.eq('featureManager/:type')
    expect(Routes.childRoutes[3].path).to.eq('featureManager')
  ...
  it('featureManager should return OAISFeatureManagerContainer with type', (done) => {
