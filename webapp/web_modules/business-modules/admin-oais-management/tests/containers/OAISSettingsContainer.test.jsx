...
/**
 * Test OAISSettingsContainer
 * @author Théo Lasserre
 */
describe('[OAIS AIP MANAGEMENT] Testing OAISSettingsContainer', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(OAISSettingsContainer)
  })
  it('should render correctly', () => {
    ...
    const enzymeWrapper = shallow(<OAISSettingsContainer {...props} />, { context })
    // check i18n
