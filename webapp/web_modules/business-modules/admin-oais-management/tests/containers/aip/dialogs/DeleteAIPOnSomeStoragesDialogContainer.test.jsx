 ...
 */
describe('[OAIS AIP MANAGEMENT] Testing DeleteAIPOnSomeStoragesDialogContainer', () => {
  ...
  it('should work correctly with query selection', () => {
    ...
    assert.equal(spiedDeleteByQuery.currentFilters, props.currentFilters, ' Delete by query should have been called with query filters')
