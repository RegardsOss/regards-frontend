 ...
 * @author Picart Kévin
 */
class RelaunchSelectedSIPsComponent extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <FlatButton
        key="relaunch"
        label={formatMessage({ id: 'oais.sips.list.relaunch.button' })}
        icon={<Relaunch />}
        disabled={disabled}
        onClick={onRelaunch}
      />
...
export default RelaunchSelectedSIPsComponent
