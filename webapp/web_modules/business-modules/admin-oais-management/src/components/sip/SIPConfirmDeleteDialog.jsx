...
class SIPConfirmDeleteDialog extends React.Component {
  ...
  renderActions = () => {
    ...
    return [
      ...
      <FlatButton
        ...
        label={formatMessage({ id: 'oais.sip.confirm.delete.sip' })}
        onClick={() => this.handleDelete(this.props.onDeleteSip)}
      />,
      <FlatButton
        key="deleteSIPS"
        className="selenium-confirmDialogButton"
        label={formatMessage({ id: 'oais.sip.confirm.delete.sips' })}
  ...
  render() {
    ...
    return (
      <Dialog
        title={formatMessage({ id: 'oais.oais.sip.confirm.delete.title' }, { id: providerId })}
        actions={this.renderActions()}
        modal={false}
        open
      >
        {formatMessage({ id: 'oais.sip.confirm.delete.message' })}
      </Dialog>
