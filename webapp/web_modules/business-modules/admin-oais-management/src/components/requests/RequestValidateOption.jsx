...
import { requestValidateActions } from '../../clients/RequestValidateClient'
...
class RequestValidateOption extends React.Component {
  ...
  static DELETE_DEPENDENCIES = requestValidateActions.getDependency(RequestVerbEnum.POST)
  ...
  render() {
    ...
    return (
      <IconButton onClick={this.onClick}><ActionDone /></IconButton>
      // <ResourceIconAction
...
export default RequestValidateOption
