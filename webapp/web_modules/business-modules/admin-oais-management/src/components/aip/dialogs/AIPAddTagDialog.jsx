...
class AIPAddTagDialog extends React.Component {
  ...
  renderActions = () => {
    ...
    return [
      <FlatButton
        ...
        label={formatMessage({ id: 'oais.aip.add-tag.action.cancel' })}
        primary
        keyboardFocused
        onClick={onClose}
      />,
      <FlatButton
        ...
        label={formatMessage({ id: 'oais.aip.add-tag.action.add' })}
  ...
  renderForm = () => {
    ...
    return (
      <div style={moduleTheme.manageTags.formInput}>
        <TextField
          hintText={this.context.intl.formatMessage({ id: 'oais.aip.add-tag.input' })}
          onChange={this.onInput}
          value={this.state.value}
        />
        <IconButton
          onClick={this.addTag}
          tooltip={this.context.intl.formatMessage({ id: 'oais.aip.add-tag.input.action.add' })}
  ...
  render() {
    ...
    return (
      <Dialog
        title={formatMessage({ id: 'oais.aip.add-tag.title' })}
        actions={this.renderActions()}
        modal={false}
        open
      >
        {this.renderForm()}
        <Subheader style={moduleTheme.manageTags.subtitle}>{formatMessage({ id: 'oais.aip.add-tag.list' })}</Subheader>
