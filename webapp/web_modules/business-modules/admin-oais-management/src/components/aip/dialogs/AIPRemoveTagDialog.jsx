...
class AIPRemoveTagDialog extends React.Component {
  ...
  renderActions = () => {
    ...
    return [
      <FlatButton
        ...
        label={formatMessage({ id: 'oais.aip.remove-tag.action.cancel' })}
        primary
        keyboardFocused
        onClick={onClose}
      />,
      <FlatButton
        ...
        label={formatMessage({ id: 'oais.aip.remove-tag.action.delete' })}
  ...
  render() {
    ...
    return (
      <Dialog
        title={formatMessage({ id: 'oais.aip.remove-tag.title' })}
      ...
      >
        ...
        >
          <Subheader style={moduleTheme.manageTags.subtitle}>{formatMessage({ id: 'oais.aip.remove-tag.available' })}</Subheader>
          {this.renderTags(tagsRemaining, this.handleRemoveTag)}
          <div style={moduleTheme.manageTags.tagsSeparator}>
            <Divider />
          </div>
          <Subheader style={moduleTheme.manageTags.subtitle}>{formatMessage({ id: 'oais.aip.remove-tag.removing' })}</Subheader>
...
export default AIPRemoveTagDialog
