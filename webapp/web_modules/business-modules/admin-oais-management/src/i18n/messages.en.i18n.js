...
export default {
  ...
  'oais.list.filters.dissemination.label': 'Dissemination',
  'oais.list.filters.dissemination.NONE': 'Not disseminated',
  'oais.list.filters.dissemination.PENDING': 'Pending',
  'oais.list.filters.dissemination.DONE': 'Done',
  ...
  'oais.packages.tooltip.errorType': 'Filter by error code',
  ...
  'oais.requests.list.filters.requestType.AIP_SAVE_METADATA': 'Save metadata',
  'oais.requests.list.filters.requestType.AIP_DISSEMINATION_CREATOR': 'Dissemination research',
  'oais.requests.list.filters.requestType.AIP_DISSEMINATION': 'Disseminate',
  ...
  'oais.list.filters.errorType.INITIAL_SIP_ALREADY_EXISTS': 'Initial - Sip already exists',
  'oais.list.filters.errorType.INITIAL_NOT_FIRST_VERSION_IGNORE': 'Initial - Inconsistent sip version (ignore)',
  'oais.list.filters.errorType.INITIAL_NOT_FIRST_VERSION_MANUAL': 'Initial - Inconsistent sip version (manual)',
  'oais.list.filters.errorType.INITIAL_UNKNOWN_VERSIONING': 'Initial - Unknown versioning',
  ...
  'oais.list.filters.errorType.UPDATE': 'Update',
  'oais.list.filters.errorType.DELETE': 'Delete',
  'oais.list.filters.errorType.AIP_DUMP': 'Aip dump',
  'oais.list.filters.errorType.NOTIFICATION': 'Notification',
  'oais.list.filters.errorType.UNEXPECTED': 'Unexpected',
  ...
  'oais.list.filters.creationDate.label': 'Creation date',
