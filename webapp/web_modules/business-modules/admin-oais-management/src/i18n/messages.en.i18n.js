...
export default {
  ...
  'oais.package.type.DATASET': 'Dataset',
  'oais.package.type.COLLECTION': 'Collection',
  'oais.package.type.any': 'All types',
  'oais.packages.list.filters.state': 'State',
  'oais.package.state.GENERATED': 'Built',
  'oais.package.state.STORED': 'Stored',
  'oais.package.state.DELETED': 'Deleted',
  'oais.package.state.any': 'All states',
  ...
  'oais.package.version.any': 'Any version',
  'oais.package.version.last': 'Last version',
  'oais.package.version.older': 'Older version',
  ...
  'oais.requests.type.STORAGE_DELETION': 'Removal ACK',
  'oais.requests.type.STORE_METADATA': 'Metadata storage',
  'oais.requests.type.UPDATE': 'Update',
  'oais.requests.type.AIP_UPDATES_CREATOR': 'Update research',
  ...
  'oais.requests.status.CREATED': 'Created',
  'oais.requests.status.BLOCKED': 'Blocked',
  'oais.requests.status.WAITING_VERSIONING_MODE': 'Waiting action...',
  'oais.requests.status.RUNNING': 'Running',
  'oais.requests.status.ERROR': 'Error',
  'oais.requests.status.ABORTED': 'Aborted',
  'oais.requests.status.IGNORED': 'Ignored',
  'oais.requests.status.any': 'Any status',
