...
export default {
  ...
  'oais.list.filters.requestIdType.STORAGE_DELETION': 'Removal ACK',
  'oais.list.filters.requestIdType.STORE_METADATA': 'Metadata storage',
  'oais.list.filters.requestIdType.UPDATE': 'Update',
  'oais.list.filters.requestIdType.AIP_UPDATES_CREATOR': 'Update research',
  'oais.list.filters.requestIdType.INGEST': 'Create',
  'oais.list.filters.requestIdType.OAIS_DELETION_CREATOR': 'Delete research',
  'oais.list.filters.requestIdType.OAIS_DELETION': 'Delete',
  'oais.list.filters.requestIdType.AIP_POST_PROCESS': 'Post process',
  ...
  'feature.list.filters.creationDate.label': 'Creation date',
  'feature.list.filters.to.label': 'To',
