...
export default {
  ...
  'oais.packages.confirm.modify.message': 'Do you want to modify selected AIP?',
  'oais.packages.modify.title': 'Modify selected AIP',
  'oais.packages.modify.list': 'Existing {pane}',
  'oais.packages.modify.delete': '{pane} to delete',
  'oais.packages.modify.add': '{pane} to add',
  'oais.packages.modify.storages': 'Storages',
  'oais.packages.modify.categories': 'Categories',
