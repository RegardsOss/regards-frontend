...
export default {
  ...
  'oais.list.filters.dissemination.label': 'Diffusion',
  'oais.list.filters.dissemination.NONE': 'Non diffusé',
  'oais.list.filters.dissemination.PENDING': 'En cours',
  'oais.list.filters.dissemination.DONE': 'Terminé',
  ...
  'oais.packages.modify.warning': 'Attention: un produit ne peut contenir qu’une seule catégorie',
  ...
  'oais.packages.details.sip.message': 'Attention : Le contenu original du sip a été purgée car il a dépassé la date de rétension maximale.',
  ...
  'oais.packages.tooltip.errorType': 'Filter par code d\'erreur',
  ...
  'oais.packages.tooltip.notify': 'Notifier le produit',
  'oais.packages.tooltip.notify.header': 'Notifier la selection',
  'oais.packages.tooltip.notify.title': 'Notifier les produits sélectionnés',
  ...
  'oais.requests.list.filters.requestType.AIP_SAVE_METADATA': 'Sauvegarde des métadonnées',
  'oais.requests.list.filters.requestType.AIP_DISSEMINATION_CREATOR': 'Recherche de dissemination',
  'oais.requests.list.filters.requestType.AIP_DISSEMINATION': 'Dissemination',
  ...
  'oais.list.filters.requestState.WAITING_NOTIFIER_RESPONSE': 'En attente de notification',
  'oais.list.filters.errorType.label': 'Code d\'erreur',
  'oais.list.filters.errorType.INITIAL': 'Initial',
  'oais.list.filters.errorType.INITIAL_CHECKSUM': 'Initial - Sip checksum incorrect',
  'oais.list.filters.errorType.INITIAL_SIP_ALREADY_EXISTS': 'Initial - Sip déjà existant',
  'oais.list.filters.errorType.INITIAL_NOT_FIRST_VERSION_IGNORE': 'Initial - Version sip incorrecte (ignore)',
  'oais.list.filters.errorType.INITIAL_NOT_FIRST_VERSION_MANUAL': 'Initial - Version sip incorrecte (manual)',
  'oais.list.filters.errorType.INITIAL_UNKNOWN_VERSIONING': 'Initial - Versionnement inconnu',
  'oais.list.filters.errorType.PREPROCESSING': 'Preprocessing',
  'oais.list.filters.errorType.VALIDATION': 'Validation',
  'oais.list.filters.errorType.GENERATION': 'Generation',
  'oais.list.filters.errorType.METADATA': 'Metadata',
  'oais.list.filters.errorType.TAGGING': 'Tagging',
  'oais.list.filters.errorType.POSTPROCESSING': 'Post processing',
  'oais.list.filters.errorType.FINAL': 'Final',
  'oais.list.filters.errorType.UPDATE': 'Mise à jour',
  'oais.list.filters.errorType.DELETE': 'Suppression',
  'oais.list.filters.errorType.AIP_DUMP': 'Aip dump',
  'oais.list.filters.errorType.NOTIFICATION': 'Notification',
  'oais.list.filters.errorType.UNEXPECTED': 'Inattendu',
  ...
  'oais.list.filters.creationDate.label': 'Date de création',
