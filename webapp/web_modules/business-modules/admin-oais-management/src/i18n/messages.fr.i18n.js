...
export default {
  ...
  'oais.list.filters.requestIdType.label': 'Type',
  'oais.list.filters.requestIdType.STORAGE_DELETION': 'ACK suppression',
  'oais.list.filters.requestIdType.STORE_METADATA': 'Stockage des méta-données',
  'oais.list.filters.requestIdType.UPDATE': 'Mise à jour',
  'oais.list.filters.requestIdType.AIP_UPDATES_CREATOR': 'Recherche de mises à jour',
  'oais.list.filters.requestIdType.INGEST': 'Création',
  'oais.list.filters.requestIdType.OAIS_DELETION_CREATOR': 'Recherche de suppressions',
  'oais.list.filters.requestIdType.OAIS_DELETION': 'Suppressions',
  'oais.list.filters.requestIdType.AIP_POST_PROCESS': 'Post traitement',
  ...
  'feature.list.filters.creationDate.label': 'Date de création',
  'feature.list.filters.to.label': 'Jusqu\'à',
