...
export default {
  ...
  'oais.packages.list.filters.providerId': 'ID fournisseur',
  'oais.packages.list.filters.type': 'Type',
  'oais.package.type.DATA': 'Donnée',
  'oais.package.type.DATASET': 'Jeu de données',
  'oais.package.type.COLLECTION': 'Collection',
  'oais.package.type.any': 'Tous types',
  'oais.packages.list.filters.state': 'État',
  'oais.package.state.GENERATED': 'Généré',
  'oais.package.state.STORED': 'Stocké',
  'oais.package.state.DELETED': 'Supprimé',
  'oais.package.state.any': 'Tout état',
  'oais.packages.list.filters.session': 'Session',
  'oais.packages.list.filters.storage': 'Stockage',
  'oais.package.storage.any': 'Tout stockage',
  'oais.package.version.any': 'Toute version',
  'oais.package.version.last': 'Dernière version',
  'oais.package.version.older': 'Version antérieure',
  ...
  'oais.requests.type.STORAGE_DELETION': 'ACK suppression',
  'oais.requests.type.STORE_METADATA': 'Stockage des méta-données',
  'oais.requests.type.UPDATE': 'Mise à jour',
  'oais.requests.type.AIP_UPDATES_CREATOR': 'Recherche de mises à jour',
  ...
  'oais.requests.status.CREATED': 'Créé',
  'oais.requests.status.BLOCKED': 'Bloqué',
  'oais.requests.status.WAITING_VERSIONING_MODE': 'Attente d\'action...',
  'oais.requests.status.RUNNING': 'En cours',
  'oais.requests.status.ERROR': 'Erreur',
  'oais.requests.status.ABORTED': 'Annulé',
  'oais.requests.status.IGNORED': 'Ignoré',
  'oais.requests.status.any': 'Tout statut',
  ...
  'oais.aips.list.aip-details.title': 'Erreurs de la requête',
