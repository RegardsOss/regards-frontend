 ...
 */
  ...
  static onPropertiesUpdated(oldProps, newProps) {
    ...
    if (!isEqual(oldProps.oaisFilters, oaisFilters) || !isEqual(oldProps.openedPane, openedPane)) {
      ...
      if (!isAipsFetching) {
        const aipBodyParameters = OAISSwitchTablesContainer.buildBodyParameters(bodyParameters, IngestDomain.AipFilters.buildDefault())
      ...
      if (!isRequestsFetching) {
        const requestsBodyParameters = OAISSwitchTablesContainer.buildBodyParameters(bodyParameters, IngestDomain.RequestFilters.buildDefault())
  ...
  UNSAFE_componentWillMount() {
    ...
    OAISSwitchTablesContainer.onPropertiesUpdated({}, { ...this.props, oaisFilters })
  }
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    OAISSwitchTablesContainer.onPropertiesUpdated(this.props, nextProps)
  }
  ...
  getNbElementsInfos = (pane) => {
    ...
    return OAISSwitchTablesContainer.extractInfos(meta)
  }
