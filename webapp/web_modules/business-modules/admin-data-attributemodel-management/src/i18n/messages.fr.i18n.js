...
const messages = {
  ...
  'attrmodel.form.config.elastic.type.SIMPLE.searchable.dialog.title': 'Modification de l\'option Recherchable',
  'attrmodel.form.config.elastic.type.SIMPLE.searchable.dialog.message': 'Si vous modifiez la recherchabilité d\'un attribut, vous devez effacer l\'index manuellement puis réindexer tout votre catalogue. Rendre un attribut recherchable sur un grand volume de données utilise un très grand volume sur disque, veillez à ne rendre recherchable que les attributs qui doivent l\'être.',
