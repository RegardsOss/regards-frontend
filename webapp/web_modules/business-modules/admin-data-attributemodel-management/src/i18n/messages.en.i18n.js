...
const messages = {
  ...
  'attrmodel.form.config.elastic.type.SIMPLE.searchable.dialog.title': 'Edit indexable option',
  'attrmodel.form.config.elastic.type.SIMPLE.searchable.dialog.message': 'If you change the searchability of this attribute, you must clear the index manually then reindex all your catalog. Making an attribute searchable on a large volume of data uses a very large volume on disk, be sure to make searchable only attributes that should be searchable.',
