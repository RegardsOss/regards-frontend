...
const messages = {
  ...
  'attrmodel.form.config.elastic': 'ElasticSearch Configuration',
  'attrmodel.form.config.elastic.type.SIMPLE': 'Simple',
  'attrmodel.form.config.elastic.type.SIMPLE.searchable': 'Searchable',
  'attrmodel.form.config.elastic.type.SIMPLE.searchable.info.button': 'Details',
  'attrmodel.form.config.elastic.type.SIMPLE.searchable.dialog.title': 'Edit indexable attribute',
  'attrmodel.form.config.elastic.type.SIMPLE.searchable.dialog.message': 'If you toggle the searchability of this attribute, you must clear the index manually then reindex all your catalog. Making an attribute searchable on a large volume of data uses a very large volume on disk, be sure to make searchable only attributes that should be searchable.',
  'attrmodel.form.config.elastic.type.SIMPLE.searchable.dialog.close': 'Close',
  'attrmodel.form.config.elastic.type.SIMPLE.restrict': 'Restrict research to specific fields',
  'attrmodel.form.config.elastic.type.SIMPLE.restrict.fields.title': 'JsonPath of searchable fields',
  'attrmodel.form.config.elastic.type.SIMPLE.restrict.fields.add.warn': 'Confirm field add',
  'attrmodel.form.config.elastic.type.SIMPLE.restrict.fields.add.exist': 'Field already exist',
  'attrmodel.form.config.elastic.type.SIMPLE.restrict.fields.hint': 'New field',
  'attrmodel.form.config.elastic.type.ADVANCED': 'Advanced',
  'attrmodel.form.config.elastic.type.ADVANCED.esmapping': 'ElasticSearch Mapping',
