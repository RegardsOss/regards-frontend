...
const messages = {
  ...
  'microservice-management.rs-lta-manager.description': 'Configuration du service de gestion des demandes de pérenisation (LTA)',
  'microservice-management.rs-delivery.description': 'Configuration du service de gestion des demandes de livraison',
  ...
  'microservice.conf-backup.rs-access-project.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-admin-project.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-authentication.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-catalog.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-dam.subtitle': 'Le paramètre resetBeforeImport=true ne prend en compte que les paramètres de type "dynamic settings" (voir la documentation en ligne: https://regardsoss.github.io/docs/development/services/dam/configuration/import-export)',
  'microservice.conf-backup.rs-dataprovider.subtitle': 'Le paramètre resetBeforeImport=true ne prend en compte que les paramètres de type "dynamic settings" (voir la documentation en ligne: https://regardsoss.github.io/docs/development/services/dataprovider/configuration/import-export).',
  'microservice.conf-backup.rs-delivery.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-order.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-storage.subtitle': 'Le paramètre resetBeforeImport=true ne prend en compte que les paramètres de type "dynamic settings" (voir la documentation en ligne: https://regardsoss.github.io/docs/development/services/dataprovider/configuration/import-export).',
  'microservice.conf-backup.rs-ingest.subtitle': 'Le paramètre resetBeforeImport=true ne prend en compte que les paramètres de type "dynamic settings" (voir la documentation en ligne: https://regardsoss.github.io/docs/development/services/dataprovider/configuration/import-export).',
  'microservice.conf-backup.rs-fem.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-notifier.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-processing.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-worker-manager.subtitle': 'Importer ou télécharger la configuration de ce microservice',
  'microservice.conf-backup.rs-lta-manager.subtitle': 'Importer ou télécharger la configuration de ce microservice',
