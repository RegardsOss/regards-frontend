...
const messages = {
  ...
  'microservice.conf-backup.rs-access-project.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-admin-project.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-authentication.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-catalog.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-dam.subtitle': 'The resetBeforeImport=true parameter only takes into account parameters of type "dynamic settings" (see the online documentation https://regardsoss.github.io/docs/development/services/dam/configuration/import-export).',
  'microservice.conf-backup.rs-dataprovider.subtitle': 'The resetBeforeImport=true parameter only takes into account parameters of type "dynamic settings" (see the online documentation https://regardsoss.github.io/docs/development/services/dam/configuration/import-export).',
  'microservice.conf-backup.rs-delivery.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-order.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-storage.subtitle': 'The resetBeforeImport=true parameter only takes into account parameters of type "dynamic settings" (see the online documentation https://regardsoss.github.io/docs/development/services/dam/configuration/import-export).',
  'microservice.conf-backup.rs-ingest.subtitle': 'The resetBeforeImport=true parameter only takes into account parameters of type "dynamic settings" (see the online documentation https://regardsoss.github.io/docs/development/services/dam/configuration/import-export).',
  'microservice.conf-backup.rs-fem.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-notifier.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-processing.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-worker-manager.subtitle': 'Import or export the configuration of this microservice',
  'microservice.conf-backup.rs-lta-manager.subtitle': 'Import or export the configuration of this microservice',
