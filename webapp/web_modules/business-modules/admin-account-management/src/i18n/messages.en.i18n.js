...
const messages = {
  ...
  'account.list.table.status.EMAIL_VERIFICATION': 'Waiting for email verification',
  ...
  'account.list.table.filters.status.EMAIL_VERIFICATION': 'Waiting for email verification',
  ...
  'account.list.table.status.label.EMAIL_VERIFICATION': 'Waiting for email verification',
  ...
  'account.list.table.action.send.email.tooltip': 'Resend confirmation email',
  ...
  'account.list.email.confirmation.message': 'Send confirmation email to {email}?',
