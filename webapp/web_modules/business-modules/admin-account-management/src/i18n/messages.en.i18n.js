...
const messages = {
  ...
  'account.list.table.project': 'Projects',
  'account.list.table.filters.firstname': 'First name',
  'account.list.table.filters.lastname': 'Last name',
  'account.list.table.filters.email': 'E-mail',
  'account.list.table.filters.status': 'Status',
  ...
  'account.list.table.filters.origin': 'Origin',
  'account.list.table.filters.origin.any': 'All origins',
  'account.list.table.filters.project': 'Project',
  'account.list.table.filters.project.any': 'All projects',
