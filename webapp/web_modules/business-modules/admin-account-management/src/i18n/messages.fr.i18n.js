...
const messages = {
  ...
  'account.list.table.status.PENDING': 'En attente',
  'account.list.table.status.ACTIVE': 'Actif',
  'account.list.table.status.LOCKED': 'Verrouillé',
  'account.list.table.status.INACTIVE': 'Inactif',
  'account.list.table.status.INACTIVE_PASSWORD': 'Mot de passe expiré',
  'account.list.table.status.EMAIL_VERIFICATION': 'En attente de vérification de l\'email',
  'account.list.table.origin': 'Origine',
  'account.list.table.projects': 'Projets',
  'account.list.table.filters.firstName.label': 'Prénom',
  'account.list.table.filters.lastName.label': 'Nom',
  'account.list.table.filters.email.label': 'E-mail',
  'account.list.table.filters.status.label': 'Statut',
  'account.list.table.filters.status.any': 'Tous les statuts',
  ...
  'account.list.table.filters.status.INACTIVE_PASSWORD': 'Mot de passe expiré',
  'account.list.table.filters.status.EMAIL_VERIFICATION': 'En attente de vérification de l\'email',
  ...
  'account.list.table.status.label.EMAIL_VERIFICATION': 'En attente de vérification de l\'email',
  ...
  'account.list.table.action.send.email.tooltip': 'Renvoyer l\'email de confirmation',
  ...
  'account.list.email.confirmation.message': 'Voulez-vous envoyer un email de confirmation à {email} ?',
  ...
  'account.list.action.filter': 'Filtrer',
