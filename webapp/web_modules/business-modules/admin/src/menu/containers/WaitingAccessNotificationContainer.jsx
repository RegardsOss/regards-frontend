...
class WaitingAccessNotificationContainer extends React.Component {
  static countEntities(state) {
    return waitingAccessUsersEntitiesSelectors.getSize(state)
  }

  render() {
    // instantiate refresh handler and notification displayer
    return <NotificationCountContainer entitiesCounter={WaitingAccessNotificationContainer.countEntities} {...this.props} />
  }
}
