...
const messages = Object.assign({
  'model.attribute.calculation.plugins.list.title': 'Configuration des plugins de calculs des attributs du model',
  ...
  'model.attribute.calculation.plugins.form.edit.title': 'Edition du plugin de calcul "{name}"',
