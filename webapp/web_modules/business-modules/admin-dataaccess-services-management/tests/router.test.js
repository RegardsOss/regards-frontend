...
import ServiceFormContainer from '../src/containers/ServiceFormContainer'
 ...
 */
describe('[ADMIN CATALOG SERVICES] Testing router', () => {
  ...
  it('create should return ServiceFormContainer for create new conf', (done) => {
    Routes.childRoutes[1].getComponents(undefined, (smth, component) => {
      expect(component.content).to.eq(ServiceFormContainer)
      done()
    })
  })
