...
import { AuthenticationPluginFormComponent } from '../../src/components/AuthenticationPluginFormComponent'
import styles from '../../src/styles/styles'

const context = buildTestContext(styles)

/**
* Test AuthenticationPluginFormComponent
* @author Sébastien Binda
*/
describe('[ADMIN AUTHENTICATION PLUGINS] Testing AuthenticationPluginFormComponent', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(AuthenticationPluginFormComponent)
  })
  it('should render correctly creation form', () => {
    ...
    const enzymeWrapper = shallow(<AuthenticationPluginFormComponent {...props} />, { context })
    assert.lengthOf(enzymeWrapper.find(PluginListContainer), 1, 'The component should display the list of available services')
    assert.lengthOf(enzymeWrapper.find(PluginFormContainer), 0, 'The component should display the authentication plugin configurator')
  })
