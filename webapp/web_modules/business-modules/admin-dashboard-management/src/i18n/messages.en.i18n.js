...
const messages = {
  ...
  'dashboard.selectedsession.referencing.ingest.dialog.retry.message': 'You are about to relaunch the generation of the products in errors and / or the storage / reference of the associated files. This action may take some time, you can see the progress of this relaunch by refreshing this page regularly.',
  ...
  'dashboard.selectedsession.storage.dialog.retry.title': 'Retry errors ?',
  'dashboard.selectedsession.storage.dialog.retry.message': 'You are about to rerun all failed requests (store / reference / deletes and copies). This action may take some time, you can see the progress of this relaunch by refreshing this page regularly.',
