...
const messages = {
  ...
  'dashboard.selectedsession.storage.referenceRequests.tooltip': '{value} referencing request(s)',
  'dashboard.selectedsession.storage.storeRequests.tooltip': '{value} archival request(s)',
  'dashboard.selectedsession.storage.copyRequests.tooltip': '{value} copy request(s)',
  'dashboard.selectedsession.storage.deleteRequests.tooltip': '{value} deletion request(s)',
  'dashboard.selectedsession.storage.requestsRefused.tooltip': '{value} refused request(s)',
  'dashboard.selectedsession.storage.requestsErrors.tooltip': '{value} request(s) in error',
  'dashboard.selectedsession.storage.storedFiles.tooltip': '{value} stored file(s) in archival',
  'dashboard.selectedsession.storage.referencedFiles.tooltip': '{value} referenced files in archival',
  'dashboard.selectedsession.storage.deletedFiles.tooltip': '{value} fichier(s) deleted files in archival',
  ...
  'dashboard.selectedsession.diffusion.indexed.tooltip': '{value} product(s) diffused',
  'dashboard.selectedsession.diffusion.indexedError.tooltip': '{value} product(s) could not be diffused',
