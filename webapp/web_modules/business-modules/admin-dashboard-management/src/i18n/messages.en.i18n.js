...
const messages = {
  ...
  'dashboard.filter.sourceName.label': 'Source name',
  'dashboard.filter.sessionName.label': 'Session name',
  'dashboard.filter.sourceState.label': 'Source state',
  'dashboard.filter.sessionState.label': 'Session state',
  'dashboard.filter.name': 'Search a name...',
  'dashboard.filter.sessionState.ok': 'Ok',
  'dashboard.filter.sessionState.errors': 'Error',
  'dashboard.filter.sessionState.running': 'Running',
  'dashboard.filter.sessionState.waiting': 'Waiting',
  'dashboard.filter.sourceState.ok': 'Ok',
  'dashboard.filter.sourceState.errors': 'Error',
  'dashboard.filter.sourceState.running': 'Running',
  'dashboard.filter.sourceState.waiting': 'Waiting',
  ...
  'dashboard.selectedsession.ACQUISITION.dp.invalid.tooltip': '{value} product(s) invalid. An invalid product indicates that too many scanned files have been associated with the product',
  ...
  'dashboard.selectedsession.ACQUISITION.dp.button.see-chains': 'See chains',
