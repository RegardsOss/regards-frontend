...
const messages = {
  ...
  'dashboard.selectedsession.storage.storedFiles': 'Produits archivés : {value}',
  'dashboard.selectedsession.storage.referencedFiles': 'Produits référencés : {value}',
  'dashboard.selectedsession.storage.deletedFiles': 'Produits supprimés : {value}',
