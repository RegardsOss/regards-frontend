...
const messages = {
  ...
  'dashboard.filter.name.label': 'Nom :',
  'dashboard.filter.status.label': 'Statut :',
  'dashboard.filter.name': 'Rechercher un nom...',
  'dashboard.filter.status': 'Sélectionner un statut',
  'dashboard.filter.status.all': 'Tous',
  'dashboard.filter.status.ok': 'Ok',
  'dashboard.filter.status.errors': 'Erreur',
  'dashboard.filter.status.running': 'En cours',
  'dashboard.filter.status.waiting': 'En attente',
