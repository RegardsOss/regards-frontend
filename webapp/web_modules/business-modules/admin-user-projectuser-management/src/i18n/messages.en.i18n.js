...
const messages = {
  ...
  'projectUser.list.card.selectField.account': 'Visualisation mode : Account',
  ...
  'projectUser.list.table.role.label.PUBLIC': 'Public',
  'projectUser.list.table.role.label.REGISTERED_USER': 'Registered user',
  'projectUser.list.table.role.label.EXPLOIT': 'Operator',
  'projectUser.list.table.role.label.ADMIN': 'Administrator',
  'projectUser.list.table.role.label.PROJECT_ADMIN': 'Super Administrator',
  'projectUser.list.table.role.label.INSTANCE_ADMIN': 'Instance Administrator',
  'projectUser.list.table.role.label.any': 'All roles',
  'projectUser.list.table.email': 'E-mail',
  'projectUser.list.table.lastname': 'Lastname',
  'projectUser.list.table.firstname': 'Firstname',
  'projectUser.list.table.status': 'Status',
  'projectUser.list.table.status.label.any': 'All status',
  ...
  'projectUser.list.table.origin': 'Origin',
  'projectUser.list.table.origin.label.any': 'All origins',
  'projectUser.list.table.created': 'Creation date',
  'projectUser.list.table.created.label': 'Creation date :',
  'projectUser.list.table.created.createdBefore.label': 'From',
  'projectUser.list.table.created.createdAfter.label': 'To',
  'projectUser.list.table.lastConnection': 'Last connection',
  'projectUser.list.table.lastConnection.label': 'Last connection :',
  'projectUser.list.table.lastConnection.lastConnectionBefore.label': 'From',
  'projectUser.list.table.lastConnection.lastConnectionAfter.label': 'To',
