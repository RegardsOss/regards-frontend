...
const messages = {
  ...
  'projectUser.list.table.created.createdBefore.label': 'To',
  'projectUser.list.table.created.createdAfter.label': 'From',
  'projectUser.list.table.lastConnection': 'Last connection',
  'projectUser.list.table.lastConnection.label': 'Last connection :',
  'projectUser.list.table.lastConnection.lastConnectionBefore.label': 'To',
  'projectUser.list.table.lastConnection.lastConnectionAfter.label': 'From',
