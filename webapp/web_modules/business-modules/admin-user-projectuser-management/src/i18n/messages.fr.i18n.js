...
const messages = {
  ...
  'projectUser.list.table.role.label.REGISTERED_USER': 'Utilisateur enregistré',
  'projectUser.list.table.role.label.EXPLOIT': 'Exploitant',
  'projectUser.list.table.role.label.ADMIN': 'Administrateur',
  'projectUser.list.table.role.label.PROJECT_ADMIN': 'Super Administrateur',
  'projectUser.list.table.role.label.INSTANCE_ADMIN': 'Administrateur Instance',
  ...
  'projectUser.list.table.groups.label': 'Groupes :',
  ...
  'projectUser.list.table.created.createdBefore.label': 'Jusqu\'à',
  'projectUser.list.table.created.createdAfter.label': 'Depuis',
  'projectUser.list.table.lastConnection': 'Dernière connexion',
  'projectUser.list.table.lastConnection.label': 'Dernière connexion :',
  'projectUser.list.table.lastConnection.lastConnectionBefore.label': 'Jusqu\'à',
  'projectUser.list.table.lastConnection.lastConnectionAfter.label': 'Depuis',
