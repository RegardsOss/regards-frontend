...
const messages = Object.assign({
  ...
  'document.list.action.edit': 'Éditer',
  ...
  'document.form.geometry': 'Géométrie',
  ...
  'document.edit.title': 'Édition du document {name}',
  'document.create.title': 'Création d\'un document',
  'document.duplicate.title': 'Dupliquer le document {name}',
  'invalid.max_128_carac': 'Le label d\'un document ne peut dépasser 128 caractères',

  'document.stepper.links': 'Édition des liens avec les collections',
