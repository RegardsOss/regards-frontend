 ...
 */
describe('[ADMIN STORAGE AIP MANAGEMENT] Testing DeleteSelectedAIPsOnSomeStoragesOptionComponent', () => {
  ...
  it('should render correctly disabled', () => {
    ...
    testSuiteHelpers.assertWrapperProperties(buttonWrapper, {
      label: 'aips.list.delete.files.on.some.storages.label',
      title: 'aips.list.delete.files.on.some.storages.title',
      disabled: true,
