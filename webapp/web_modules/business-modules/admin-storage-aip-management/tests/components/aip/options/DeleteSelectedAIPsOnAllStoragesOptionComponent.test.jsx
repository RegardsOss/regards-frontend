 ...
 */
describe('[ADMIN STORAGE AIP MANAGEMENT] Testing DeleteSelectedAIPsOnAllStoragesOptionComponent', () => {
  ...
  it('should render correctly disabled', () => {
    ...
    testSuiteHelpers.assertWrapperProperties(buttonWrapper, {
      label: 'aips.list.delete.files.on.all.storages.label',
      title: 'aips.list.delete.files.on.all.storages.title',
      disabled: true,
