...
import DeleteAIPOnSomeStoragesOption, { HateoasIconAction } from '../../../../src/components/aip/options/DeleteAIPOnSomeStoragesOption'
...
/**
 * Test DeleteAIPOnSomeStoragesOption
 * @author Raphaël Mechali
 */
describe('[ADMIN STORAGE AIP MANAGEMENT] Testing DeleteAIPOnSomeStoragesOption', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(DeleteAIPOnSomeStoragesOption)
  })
  it('should render and invoke callback correctly', () => {
    ...
    const enzymeWrapper = shallow(<DeleteAIPOnSomeStoragesOption {...props} />, { context })
    ...
    assert.equal(iconButtonWrapper.props().title, 'aips.list.delete.files.on.some.storages.title', 'Tooltip should be internationalized')
