 ...
 */
describe('[ADMIN STORAGE AIP MANAGEMENT] Testing AIPStoreRetryOption', () => {
  ...
  it('should render and invoke callback correctly', () => {
    ...
    assert.equal(iconButtonWrapper.props().title, 'aips.list.aip-retry.title', 'Tooltip should be internationalized')
