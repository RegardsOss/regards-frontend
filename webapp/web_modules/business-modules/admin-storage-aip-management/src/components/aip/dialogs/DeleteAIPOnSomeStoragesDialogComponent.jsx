...
class DeleteAIPOnSomeStoragesDialogComponent extends React.Component {
  ...
  renderActions = () => {
    ...
    return [
      <FlatButton
        ...
        label={formatMessage({ id: 'aip.cancel.delete.on.storages' })}
        primary
        keyboardFocused
        onClick={onClose}
      />,
      <FlatButton
        ...
        label={formatMessage({ id: 'aip.confirm.delete.on.storages' })}
  ...
  render() {
    ...
    return (
      <Dialog
        title={<CardHeader
          title={formatMessage({ id: 'aip.delete.on.storages.title' })}
          titleStyle={titleStyle}
          subtitle={formatMessage({ id: 'aip.delete.on.storages.message' })}
