 ...
 */
class ProductStateRender extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    const textValue = intl.formatMessage({ id: `acquisition.product.list.filters.state.${value}` })
    return (
...
export default ProductStateRender
