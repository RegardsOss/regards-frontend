...
import { SessionsMonitoringGeneratedAipRenderer } from '../../../../src/components/session/render/SessionsMonitoringGeneratedAipRenderer'
...
/**
 * Test SessionsMonitoringGeneratedAipRenderer
 * @author Kévin Picart
 */
describe('[ADMIN DATA PROVIDER MANAGEMENT] Testing SessionsMonitoringGeneratedAipRenderer', () => {
  before(testSuiteHelpers.before)
  after(testSuiteHelpers.after)

  it('should exists', () => {
    assert.isDefined(SessionsMonitoringGeneratedAipRenderer)
  })
  it('should render correctly', () => {
    ...
    const enzymeWrapper = shallow(<SessionsMonitoringGeneratedAipRenderer {...props} />, { context })
